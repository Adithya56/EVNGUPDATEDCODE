 ...
 <div align="center" class="container mt-3">
  <div id="checkpincode" class="row justify-content-center">
    ...
    <div class="col-md-3" id="btn">
      <button  type="button" id="pincodebtn" class="btn btn-primary pincode" onclick="checkValidity()">Pincode Check</button>
    </div>
  </div>
  <br/>
  <div id="tcost"></div>
...
function checkValidity(){
	console.log("Entered into pincode");
	...
	$.ajax({
        ...
        success: function(response) {
            console.log("response of validity  "+response);
            if(response=="true"){
